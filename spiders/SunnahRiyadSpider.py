...
class SunnahRiyadSpider(scrapy.Spider):
    name = "Riyad"
    allowed_domains = ['sunnah.com']
    start_urls = ['https://sunnah.com/riyadussalihin']
    base_url = 'https://sunnah.com/riyadussalihin'
    ...
    def parse_hadits(self, response):
        hadits_container = response.css('div.actualHadithContainer.hadith_container_riyadussalihin')
        hadits = []
