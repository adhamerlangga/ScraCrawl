...
class SunnahMishkatSpider(scrapy.Spider):
    name = "Mishkat"
    allowed_domains = ['sunnah.com']
    start_urls = ['https://sunnah.com/mishkat']
    base_url = 'https://sunnah.com/mishkat'
    ...
    def parse_hadits(self, response):
        hadits_container = response.css('div.actualHadithContainer.hadith_container_mishkat')
        hadits = []
