...
class SunnahNasaiSpider(scrapy.Spider):
    name = "Nasai"
    allowed_domains = ['sunnah.com']
    start_urls = ['https://sunnah.com/nasai']
    base_url = 'https://sunnah.com/nasai'
    ...
    def parse_hadits(self, response):
        hadits_container = response.css('div.actualHadithContainer.hadith_container_nasai')
        hadits = []
